...
[MCO](https://www.distaranimation.com/mods/attack) is included, with grounded and non-flashy movesets. You can power attack with `M3`. You can [dodge](https://www.nexusmods.com/skyrimspecialedition/mods/56956) as well, using `C` or `SHIFT` with your weapon drawn. Combat is meant for third person, but playable in first person as well.
...
<details><summary>Custom NPC Locations (expand)</summary>

### Custom NPC Locations

| Name | Armor | Location | Level |
|-----|-----|-----|-----|
| Avier of Rihad | Rihad Swordsman | Fort Greymoor | 15 |
| True Nord Bjornar | Wind Ruler | Windhelm Docks | 20 |
| Danya of Riverwood | Gorm Armor | Bleak Falls Barrow | 12 |
| Dayvur Fireblade | Nightingale Sentinel  | Twilight Sepulcher | 30 |
| Fluted Knight Evetta | Fluted | Eldergleam Sanctuary | 25 |
| Frovir Wolf-Claw | Northern God | Dawnstar Bandit Camp | 25 |
| Geborgen | Yaldabaoth | Understone Keep | 25 |
| Knight-Paladin Helos | Gryphonknight Regalia | Ustengrav | 20 |
| Nazeem, the Knight of the Cloud District | Crown Plate | Dragonsreach | 12 |
| Sylvia the Breton | Breton Knight | Shrine of Azura | 25 |
| Thonel, the Oblivion Walker | Mehrunes Dagon | Shrine of Mehrunes Dagon | 30 |
| Imperial Ambassador Victor | Colovian Prince | East Empire Company Warehouse | 25 |

You can also find two bandits on the road leading to Hammerfell, kill them to obtain the Infantry light and heavy armor. These are not custom NPCs.
...
To your right you will see a chest with some starting items, and to your right is a skill book which you should grab. You should also pick up the note on the table. From there, talk to the NPC to begin the main quest.
